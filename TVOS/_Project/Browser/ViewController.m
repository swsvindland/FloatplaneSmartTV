...
-(void)loadHomePage {
    if ([[NSUserDefaults standardUserDefaults] stringForKey:@"homepage"] != nil) {
        ...
        [self.webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString: @"https://www.floatplane.com/login"]]];
    }
}
-(void)initWebView {
...
-(void)showInputURLorSearchGoogle
{
    ...
    UIAlertAction *searchAction = [UIAlertAction
                                   ...
                                   handler:^(UIAlertAction *action)
                                   {
                                       ...
                                       toMod = [toMod stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
                                       if (toMod != nil) {
                                           [self.webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://www.floatplane.com/login"]]]];
                                       }
                                       else {
                                           [self requestURLorSearchInput];
                                       }
